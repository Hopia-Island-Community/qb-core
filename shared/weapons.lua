...
QBShared.Weapons = {
	...
	[`weapon_musket`] 			     = {['name'] = 'weapon_musket', 			['label'] = 'Musket', 					['ammotype'] = 'AMMO_HUNT',	    ['damagereason'] = 'Devastated / Pulverized / Shotgunned'},
    ...
    [`weapon_paintgun`]             = {['name'] = 'weapon_paintgun',            ['label'] = 'Fusil Paint-Ball',         ['ammotype'] = 'AMMO_PAINT',            ['damagereason'] = 'Peinturé'},
